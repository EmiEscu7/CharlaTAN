...
def _save_interview(
    ...
    """
    path = r".\psybot_interview\results"
...
class InterviewPolicy(Policy):
    ...
    def __init__(
        ...
        self._interview = Interview(_load_questions(
            path= "customs" + os.path.sep + "psybot_interview" + os.path.sep + "questions.json"))
    ...
    def _ask_next_question(
        ...
        'action_psybot_ask_question' dispatches it to the interviewee.
    ...
    def _user_answered_question(
        ...
        return self._prediction(
            confidence_scores_for("action_psybot_ask_again", 1.0, domain))
    ...
    def predict_action_probabilities(
        ...
        if tracker.latest_action_name == "action_listen":
            ...
            if ("want_interview" in intent_name
